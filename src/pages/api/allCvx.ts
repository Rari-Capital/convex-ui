...
export default async (req: NextApiRequest, res: NextApiResponse) => {
 ...
 const booster = new Contract("0xF403C135812408BFbE8713b5A23a04b3D48AAE31", ABI, provider)

  let p = []
  for (let i=0; i < poolLength; i++){
    p.push(booster.callStatic.poolInfo(i))
  }
